...
//!   6. event emission.
//!
//! The fixture is a value-conserving private transfer (2 zero-value dummy inputs,
...
use crate::{Config, ExtData, Proof, PublicSignals, PoofContract, PoofContractClient};
...
fn full_transact_with_real_proof_on_host() {
    ...
    let id = env.register(PoofContract, ());
    let client = PoofContractClient::new(&env, &id);
